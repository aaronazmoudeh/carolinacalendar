var url_base = "http://wwwp.cs.unc.edu/Courses/comp426-f16/azmoudeh/final_project";
...
$(document).ready(function () {
	...
	$('.current_month').on('click', function () {
		$('.absolute').append('<b>Assignment<br></b>');
	});
    ...
    $.ajax(url_base + "/getCourses.php/" + "cards/" + cid,
       {type: "GET",
        ...
        success: function(class_json, status, jqXHR) {
            ...
            // HERE IS WHERE YOU HAVE A CARD ELEMENT WITH COURSE ID AND COURSE NAME
    }
    }
});
